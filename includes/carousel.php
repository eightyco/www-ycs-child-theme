 ...
 */
if ( !function_exists('shortcode_ycs_carousel') ) {
	function shortcode_ycs_carousel( $atts, $content = null, $shortcodename = '' ) {
	...
	add_shortcode('ycs_carousel', 'shortcode_ycs_carousel');
} ?>